...
from Tents.draw_utils import generate_number_text_image, get_num_path, get_tree_img_path, get_tent_img_path
from Tents.tents_classes import BoardNode, TreeNode, ConstraintNode, PositionNode, TentNode, calculate_key
...
def test_draw_board():
    path = os.path.join(os.curdir, "test/puzzle1.txt")
    game = Tents(path)
    game.validate_and_init_game_state(path)
